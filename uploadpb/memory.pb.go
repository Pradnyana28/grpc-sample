...
type Memory struct {
	...
	Unit  Memory_Unit `protobuf:"varint,2,opt,name=unit,proto3,enum=uploads.Memory_Unit" json:"unit,omitempty"`
}
...
var file_memory_proto_rawDesc = []byte{
	...
	0x75, 0x70, 0x6c, 0x6f, 0x61, 0x64, 0x73, 0x22, 0xa8, 0x01, 0x0a, 0x06, 0x4d, 0x65, 0x6d, 0x6f,
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x14, 0x2e, 0x75, 0x70, 0x6c, 0x6f, 0x61, 0x64, 0x73,
	...
	0x10, 0x06, 0x42, 0x0c, 0x5a, 0x0a, 0x2e, 0x3b, 0x75, 0x70, 0x6c, 0x6f, 0x61, 0x64, 0x70, 0x62,
...
var file_memory_proto_goTypes = []interface{}{
	(Memory_Unit)(0), // 0: uploads.Memory.Unit
	(*Memory)(nil),   // 1: uploads.Memory
}
var file_memory_proto_depIdxs = []int32{
	0, // 0: uploads.Memory.unit:type_name -> uploads.Memory.Unit
